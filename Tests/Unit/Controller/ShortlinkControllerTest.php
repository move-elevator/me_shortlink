...
/**
 * Test case for class Tx_Me_shortlink_Controller_ShortlinkController.
 *
 * @version $Id$
 ...
 */
class Tx_Me_shortlink_Controller_ShortlinkControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
