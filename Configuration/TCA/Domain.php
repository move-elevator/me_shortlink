	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table' => 'tx_meshortlink_domain_model_domain',
				'foreign_table_where' => 'AND tx_meshortlink_domain_model_domain.pid=###CURRENT_PID### AND tx_meshortlink_domain_model_domain.sys_language_uid IN (-1,0)',
			),
		),
